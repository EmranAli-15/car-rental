    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className='why-choose-bg'>
                <div className='why-choose-gradient p-4 flex flex-col justify-center gap-y-5'>
                    <h1 className='text-2xl font-bold text-white'>Why choose AC Bus or AC Train <br /> for your One-way Journey?</h1>
                    <p className='text-white max-w-[640px]'>
